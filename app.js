  ...
  products.forEach((product) => {
    ...
    productElement.innerHTML = `
      <div class="pro-card">
        ...
        <h3>${product.name}</h3>
        <button class="product--details" data-name="${product.name}" data-price="${product.price}" data-description="${product.description}" data-image="${product.image}">Quick View</button>
      </div>
    `;
